...
let AppComponent = class AppComponent {
    constructor(platform, screenOrientation) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].StatusBar.setBackgroundColor({ color: "#3171e0" });
        });
    }
};
...
/* harmony import */ var _ionic_native_battery_status_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/battery-status/ngx */ "./node_modules/@ionic-native/battery-status/ngx/index.js");
...
module.exports = __webpack_require__(/*! G:\ionic\ChargeAlarmv2.0\ChargeAlarm\src\main.ts */"./src/main.ts");
